...
let ARS_BACKGROUND_VIEW_SIDE_LENGTH: CGFloat = 125.0 * 2/3
let ARS_STATUS_PATH_SIDE_LENGTH: CGFloat = 125.0 * 2/3

let ARS_CIRCLE_ROTATION_TO_VALUE = 2 * CGFloat.pi
let ARS_CIRCLE_ROTATION_REPEAT_COUNT = Float(UINT64_MAX)
let ARS_CIRCLE_RADIUS_OUTER: CGFloat = 40.0 * 2/3
let ARS_CIRCLE_RADIUS_MIDDLE: CGFloat = 30.0 * 2/3
let ARS_CIRCLE_RADIUS_INNER: CGFloat = 20.0 * 2/3
